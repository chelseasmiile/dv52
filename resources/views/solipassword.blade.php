<html lang="es-MX" class="js" style="--nectar-sticky-top-distance: 50px;"><head>
    ...
    <title>Solicitud de restablecimiento - DV-52 SNTE</title>
            ...
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-8 col-xl-6 text-center">
                        ...
                        <hr class="divider" />
                        <p class="text-muted mb-5">Por favor, ingresa tu dirección de correo electrónico a continuación para solicitar un restablecimiento de contraseña.</p>
                    </div>
                </div>
                  ...
                  <div class="col-lg-6 d-flex justify-content-center">
                          ...
                          <form method="POST" action="{{ route('password.email') }}">
                              ...
                              <div class="form-floating mb-3">
                                ...
                                <input class="form-control" id="email" name="email" type="email" required placeholder="Teclea tu correo electrónico" />

                          
                        </div>

                        
                        <div class="d-grid"><button class="btn btn-primary btn-xl" id="submitButton" type="submit">Enviar Correo de Restablecimiento</button>
      ...
      @endif
          ...
          <script type="text/javascript">
            document.getElementById('boton1').addEventListener('click', function(){
                alert("Se ha enviado el correo para restablecer la contraseña, ya puedes cerrar esta ventana");
