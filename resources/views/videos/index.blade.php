        ...
        <div class="vc_column-inner">
          <div class="wpb_wrapper">
            <div class="nectar-video-box" data-color="default-accent-color" data-play-button-size="default" data-border-radius="none" data-hover="defaut" data-shadow="x_large_depth">
              <div class="inner-wrap">
                <a href="https://www.youtube.com/watch?v={{ $video->youtube_video_id }}" class="full-link" data-fancybox=""></a>
                <img width="1596" height="814" src="{{ asset('storage/' . $video->miniatura) }}" class="attachment-full size-full" alt="{{ $video->titulo }}" decoding="async" loading="lazy">
                <a href="https://www.youtube.com/watch?v={{ $video->youtube_video_id }}" data-style="default" data-parent-hover="" data-font-style="p" data-color="default" class="play_button_2 large nectar_video_lightbox" data-fancybox="">
                  <span><span class="screen-reader-text">Play Video</span><span class="play"><span class="inner-wrap inner">
