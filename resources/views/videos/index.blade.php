<html lang="es-MX" class="js" style="--nectar-sticky-top-distance: 50px;"><head>
    ...
    <div><li id="menu-item-523" class="menu-item menu-item-type-custom menu-item-object-custom button_solid_color_2 menu-item-523"><a target="_blank" rel="noopener" href="{{ route('videos.create') }}"><span class="menu-title-text">Editar videos</span></a></li></div>
    </div></div>
    </div>
    </div>
    </div>
