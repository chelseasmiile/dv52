  ...
  form button:hover {
    ...
    <div class="wpb_wrapper">
        ...
        <div class="form-container">
            ...
            <form action="{{ route('quienessomos.update', $quienessomos->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="form-group">
                    <label for="vision">Visión:</label>
                    <input type="text" name="vision" id="vision" class="form-control" value="{{ $quienessomos->vision }}">
                </div>
                <div class="form-group">
                    <label for="mision">Misión:</label>
                    <input type="text" name="mision" id="mision" class="form-control" value="{{ $quienessomos->mision }}">
                </div>
                <div class="form-group">
                    <label for="valores">Valores:</label>
                    <input type="text" name="valores" id="valores" class="form-control" value="{{ $quienessomos->valores }}">
                </div>
                <div class="form-group">
