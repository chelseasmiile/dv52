<html lang="es-MX" class="js" style="--nectar-sticky-top-distance: 50px;"><head>
    ...
    <div class="nectar-flip-box" data-min-height="400" data-flip-direction="horizontal-to-left" data-h_text_align="center" data-v_text_align="center"><div class="flip-box-front" data-bg-overlay="true" data-text-color="light" style="background-image: url(&quot;https://snte.org.mx/seccion36/wp-content/uploads/sites/37/2020/01/misión.jpg&quot;); background-color: rgb(10, 10, 10); min-height: 400px; height: auto;"> <div class="inner"><img src="icons/icnestrella.png" alt="Mi Icono" style="width: 60px; height: 60px;">
    <p></p>
    <h3>Misión</h3>
    <p></p></div> </div><div class="flip-box-back" data-bg-overlay="" data-text-color="light" style="background-color: rgb(102, 102, 102); min-height: 400px; height: auto;"> <div class="inner">
    <h5>Representar, defender y reivindicar los derechos y conquistas de los trabajadores de la educación. Impulsar desde nuestro ámbito, con liderazgo, pasión e inspiración, una educación pública de calidad con estricto apego al contenido filosófico del Artículo 3o Constitucional.</h5>
    </div> </div></div>
    </div>
    </div>
    </div>
    ...
    <div class="vc_column-inner">
    <div class="wpb_wrapper" style="transform: translateZ(0px);">
    <div class="nectar-flip-box" data-min-height="400" data-flip-direction="horizontal-to-left" data-h_text_align="center" data-v_text_align="center"><div class="flip-box-front" data-bg-overlay="true" data-text-color="light" style="background-image: url(&quot;https://snte.org.mx/seccion36/wp-content/uploads/sites/37/2020/01/visión.jpeg&quot;); background-color: rgb(10, 10, 10); min-height: 400px; height: auto;"> <div class="inner"><img src="icons/icnojo.png" alt="Mi Icono" style="width: 60px; height: 60px;"><p></p>
    <h3>Visión</h3>
    <p></p></div> </div><div class="flip-box-back" data-bg-overlay="" data-text-color="light" style="background-color: rgb(255, 130, 46); min-height: 400px; height: auto;"> <div class="inner">
    <h5>Ser un Sindicato moderno, innovador y eficiente con dirigentes cercanos a sus agremiados, que concentra su atención en fortalecer la dignidad, el orgullo de ser maestro y el reconocimiento social en la tarea de la educación.</h5>
    </div> </div></div>
    </div>
    </div>
    </div>
    ...
    <div class="vc_column-inner">
    <div class="wpb_wrapper" style="transform: translateZ(0px);">
    <div class="nectar-flip-box" data-min-height="400" data-flip-direction="horizontal-to-left" data-h_text_align="center" data-v_text_align="center"><div class="flip-box-front" data-bg-overlay="true" data-text-color="light" style="background-image: url(&quot;https://snte.org.mx/seccion36/wp-content/uploads/sites/37/2020/01/valores.jpg&quot;); background-color: rgb(10, 10, 10); min-height: 400px; height: auto;"> <div class="inner"><img src="icons/icncorazon.png" alt="Mi Icono" style="width: 60px; height: 60px;"><p></p>
    <h3>Valores</h3>
    <p></p></div> </div><div class="flip-box-back" data-bg-overlay="" data-text-color="light" style="background-color: rgb(157, 36, 73); min-height: 400px; height: auto;"> <div class="inner">
    <h5>Unidad</h5>
    <h5>Honestidad</h5>
    <h5>Vocación</h5>
    <h5>Compromiso</h5>
    ...
    <div id="fws_64910c04ce6e6" data-column-margin="default" data-midnight="dark" class="wpb_row vc_row-fluid vc_row" style="padding-top: 0px; padding-bottom: 0px; "><div class="row-bg-wrap" data-bg-animation="none" data-bg-animation-delay="" data-bg-overlay="false"><div class="inner-wrap row-bg-layer"><div class="row-bg viewport-desktop" style=""></div></div></div><div class="row_col_wrap_12 col span_12 dark left">
    ...
    <h3>Asociaciones</h3>
    <p>A fin de coadyuvar en el quehacer sindical nuestra Organización cuenta con diversos Órganos, Organismos Auxiliares, Asociaciones y Fideicomisos, mismos que a continuación se mencionan:</p>
    <h3>Organismos Auxiliares</h3>
