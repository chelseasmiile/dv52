<html lang="es-MX" class="js" style="--nectar-sticky-top-distance: 50px;"><head>
    ...
    <title>Quiénes somos - Sección 36 SNTE</title>
    <link rel="canonical" href="https://snte.org.mx/seccion36/quienes-somos/">
    <meta property="og:locale" content="es_MX">
    <meta property="og:type" content="article">
    <meta property="og:title" content="Quiénes somos - Sección 36 SNTE">
    <meta property="og:url" content="https://snte.org.mx/seccion36/quienes-somos/">
    ...
    <link rel="stylesheet" id="nectar-element-flip-box-css" href="https://snte.org.mx/seccion36/wp-content/themes/salient/css/build/elements/element-flip-box.css?ver=15.0.8" type="text/css" media="all">
    ...
    <link rel="https://api.w.org/" href="https://snte.org.mx/seccion36/wp-json/"><link rel="alternate" type="application/json" href="https://snte.org.mx/seccion36/wp-json/wp/v2/pages/10"><link rel="EditURI" type="application/rsd+xml" title="RSD" href="https://snte.org.mx/seccion36/xmlrpc.php?rsd">
    <link rel="wlwmanifest" type="application/wlwmanifest+xml" href="https://snte.org.mx/seccion36/wp-includes/wlwmanifest.xml">
    <link rel="shortlink" href="https://snte.org.mx/seccion36/?p=10">
    <link rel="alternate" type="application/json+oembed" href="https://snte.org.mx/seccion36/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fsnte.org.mx%2Fseccion36%2Fquienes-somos%2F">
    <link rel="alternate" type="text/xml+oembed" href="https://snte.org.mx/seccion36/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fsnte.org.mx%2Fseccion36%2Fquienes-somos%2F&amp;format=xml">
    ...
    <div class="row">
    <div id="services" data-column-margin="default" data-midnight="dark" data-bottom-percent="5%" class="wpb_row vc_row-fluid vc_row top-level full-width-content vc_row-o-equal-height vc_row-flex vc_row-o-content-top first-section loaded" style="padding-top: 0px; padding-bottom: calc(100vw * 0.05); "><div class="row-bg-wrap" data-bg-animation="none" data-bg-animation-delay="" data-bg-overlay="false"><div class="inner-wrap row-bg-layer"><div class="row-bg viewport-desktop using-bg-color" style="background-color: #ffffff; "></div></div></div><div class="row_col_wrap_12 col span_12 dark left">
    ...
    <div id="fws_64910c04c27ed" data-midnight="" data-column-margin="default" class="wpb_row vc_row-fluid vc_row inner_row" style=""><div class="row-bg-wrap"> <div class="row-bg"></div> </div><div class="row_col_wrap_12_inner col span_12  left">
    <div class="vc_col-sm-4 vc_col-lg-4 vc_col-md-12 wpb_column column_container vc_column_container col child_column has-animation padding-1-percent triggered-animation animated-in" data-padding-pos="all" data-has-bg-color="false" data-bg-color="" data-bg-opacity="1" data-animation="grow-in" data-delay="0" style="transform: none; opacity: 1;">
    <div class="vc_column-inner">
    <div class="wpb_wrapper" style="transform: translateZ(0px);">
      @foreach($quienessomosList as $quienessomos)
      <div class="nectar-flip-box" data-min-height="400" data-flip-direction="horizontal-to-left" data-h_text_align="center" data-v_text_align="center">
          <div class="flip-box-front" data-bg-overlay="true" data-text-color="light" style="background-image: url('{{ asset('storage/' . $quienessomos->imagen_mision) }}'); background-color: rgb(10, 10, 10); min-height: 400px; height: auto;">
              <div class="inner">
                  <img src="images/icnestrella.png" alt="Mi Icono" style="width: 60px; height: 60px;">
                  <p></p>
                  <h3>Misión</h3>
                  <p></p>
              </div>
          </div>
          <div class="flip-box-back" data-bg-overlay="" data-text-color="light" style="background-color: rgb(102, 102, 102); min-height: 400px; height: auto;">
              <div class="inner">
                  <h5>{{ $quienessomos->mision }}</h5>
              </div>
          </div>
      </div>
  @endforeach
    ...
    <div class="wpb_wrapper" style="transform: translateZ(0px);">
      @foreach($quienessomosList as $quienessomos)
      <div class="nectar-flip-box" data-min-height="400" data-flip-direction="horizontal-to-left" data-h_text_align="center" data-v_text_align="center">
          <div class="flip-box-front" data-bg-overlay="true" data-text-color="light" style="background-image: url('{{ asset('storage/' . $quienessomos->imagen_vision) }}'); background-color: rgb(10, 10, 10); min-height: 400px; height: auto;">
              <div class="inner">
                  <img src="images/icnojo.png" alt="Mi Icono" style="width: 60px; height: 60px;">
                  <p></p>
                  <h3>Visión</h3>
                  <p></p>
              </div>
          </div>
          <div class="flip-box-back" data-bg-overlay="" data-text-color="light" style="background-color: rgb(255, 130, 46); min-height: 400px; height: auto;">
              <div class="inner">
                  <h5>{{ $quienessomos->vision }}</h5>
              </div>
          </div>
      </div>
  @endforeach
    ...
    <div class="wpb_wrapper" style="transform: translateZ(0px);">
      @foreach($quienessomosList as $quienessomos)
      <div class="nectar-flip-box" data-min-height="400" data-flip-direction="horizontal-to-left" data-h_text_align="center" data-v_text_align="center">
          <div class="flip-box-front" data-bg-overlay="true" data-text-color="light" style="background-image: url('{{ asset('storage/' . $quienessomos->imagen_valores) }}'); background-color: rgb(10, 10, 10); min-height: 400px; height: auto;">
              <div class="inner">
                  <img src="images/icncorazon.png" alt="Mi Icono" style="width: 60px; height: 60px;">
                  <p></p>
                  <h3>Valores</h3>
                  <p></p>
              </div>
          </div>
          <div class="flip-box-back" data-bg-overlay="" data-text-color="light" style="background-color: rgb(157, 36, 73); min-height: 400px; height: auto;">
              <div class="inner">
                  @foreach(explode(",", $quienessomos->valores) as $valor)
                      <h5>{{ trim($valor) }}</h5><br>
                  @endforeach
              </div>
          </div>
      ...
      <div class="vc_column-inner">
          <div class="wpb_wrapper">
              <div class="wpb_text_column wpb_content_element">
                  <div class="wpb_wrapper">
                      <h3 style="font-family: 'Open Sans', sans-serif;">¿Quiénes somos?</h3>
                      <p>Somos una Organización Sindical a nivel nacional, que surge por acuerdo del Congreso Nacional de Trabajadores de la Educación celebrado en diciembre de 1943, cuya misión es el estudio, defensa y mejoramiento de sus intereses comunes.</p>
    <p>La agrupación de trabajadores, decide adoptar el nombre de Sindicato Nacional de Trabajadores de la Educación, pudiendo utilizar las siglas S.N.T.E. de manera indistinta.</p>
    <p>El Sindicato Nacional de Trabajadores de la Educación lo integran trabajadores de base, permanentes, interinos y transitorios al servicio de la educación, dependientes de la Secretaría de Educación Pública, de los gobiernos de los estados, de los municipios, de empresas del sector privado, de los organismos descentralizados y desconcentrados, así como los jubilados y pensionados del servicio educativo de las entidades citadas.</p>
    <p>La Organización Sindical cuenta con registro definitivo otorgado por el Tribunal Federal de Conciliación y Arbitraje bajo el número R.S. 43/44; así como el otorgado por los Tribunales Laborales de las entidades federativas que conceden al Comité Ejecutivo Nacional del Sindicato la titularidad de la relación colectiva de trabajo.</p>
    <p>El domicilio legal del Sindicato Nacional de Trabajadores de la Educación se ubica en la calle República de Venezuela número 44, Colonia Centro en México, Ciudad de México.</p>
    <p>Por otra parte, el Sindicato se integra por Secciones, mismas que se encuentran ubicadas en cada entidad federativa y cuyo domicilio principal se sitúa en la ciudad capital de cada Estado.</p>
    <p>Consciente del compromiso que adquiere y de la misión con la que surge, la Organización decide establecer como su lema lo siguiente: “Por la Educación al Servicio del Pueblo”.</p>

    <h3 style="font-family: 'Open Sans', sans-serif;">Constitución</h3>
    <p>Se celebró el día 26 de diciembre de 1943, reuniéndose en el salón de espectáculos del Palacio de Bellas Artes de la Ciudad de México,</p>
    <p>Ciudad de México, los Delegados al Congreso de Unidad Magisterial y los Comités Ejecutivos de los Sindicatos Nacionales STERM, SUNTE y SMMTE quienes acordaron disolverlos con el fin de constituir la Organización Única de Maestros, Trabajadores Técnicos, Administrativos y Manuales al servicio de la Secretaría de Educación Pública.</p>
    <p>Por lo que el día 13 de enero de 1944 fue presentada la promoción ante el Tribunal Federal de Conciliación y Arbitraje, siendo el 16 de febrero del mismo año cuando la citada autoridad otorga el registro provisional y previos los trámites a las autoridades correspondientes, mediante Acuerdo Plenario del 29 de febrero de 1944. Concediendo el registro definitivo con el número R.S. 43/44 y por ello, reconoce al SINDICATO NACIONAL DE TRABAJADORES DE LA EDUCACIÓN.</p>

    <h3 style="font-family: 'Open Sans', sans-serif;">Marco Legal</h3>
                    <p>Nuestra Organización Sindical se constituye a partir de diversos ordenamientos legales, los cuales a continuación se mencionan:</p>
    <p>El Artículo 123, apartado “B” de la Constitución Política de los Estados Unidos Mexicanos.</p>
    <p>Asimismo, nuestra Organización al ejercer sus funciones se rige por las siguiente normatividad, reglamentaria de la citada disposición constitucional:</p>
    <p>Ley Federal de los Trabajadores al Servicio del Estado, y supletoriamente por la Ley Federal del Trabajo y el Código Federal de Procedimientos Civiles.</p>
    <h3 style="font-family: 'Open Sans', sans-serif;">Vínculos Gremiales</h3>
                    <p>Derivado de la coincidencia ideológica y doctrinaria, en el año 2004 el Sindicato Nacional de Trabajadores de la Educación, se adhiere a la Federación Democrática de Sindicatos de Servidores Públicos (FEDESSP).</p>

    <h3 style="font-family: 'Open Sans', sans-serif;">Asociaciones</h3>
    <p>A fin de coadyuvar en el quehacer sindical nuestra Organización cuenta con diversos Órganos, Organismos Auxiliares, Asociaciones y Fideicomisos, mismos que a continuación se mencionan:</p>    <h3>Organismos Auxiliares</h3>
    <p>-Consejo Nacional Técnico-Pedagógico</p>
    <p>-Instituto Global de Estudios Sindicales y Educativos (IGESE)</p>
    <h3>Asociaciones Solidarias</h3>
    <p>-Fundación Centro Cultural del México Contemporáneo, A.C.</p>
    <p>-Editorial de los Maestros “Benito Juárez”, S.C.</p>
    <h3 style="font-family: 'Open Sans', sans-serif;">Fideicomisos</h3>
                    <p>-Fondo de Retiro de los Trabajadores de la Educación</p>
                    <p>-Operadora de Centros Recreativos de los Trabajadores de la Educación</p>
    </div>
    </div>
    </div>
    </div>
  ...
  @endif
    ...
    <ul class="sub-menu">
    <li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-10 current_page_item menu-item-28"><a href="https://snte.org.mx/seccion36/quienes-somos/" aria-current="page">Quiénes somos</a></li>
    ...
    /* <![CDATA[ */
    var nectarLove = {"ajaxurl":"https:\/\/snte.org.mx\/seccion36\/wp-admin\/admin-ajax.php","postID":"10","rooturl":"https:\/\/snte.org.mx\/seccion36","disqusComments":"false","loveNonce":"5988c7969c","mapApiKey":""};
    ...
    <script defer="" src="https://static.cloudflareinsights.com/beacon.min.js/v52afc6f149f6479b8c77fa569edb01181681764108816" integrity="sha512-jGCTpDpBAYDGNYR5ztKt4BQPGef1P0giN6ZGVUi835kFF88FOmmn8jBQWNgrNd8g/Yu421NdgWhwQoaOPFflDw==" data-cf-beacon="{&quot;rayId&quot;:&quot;7da082bb6c9545f3&quot;,&quot;token&quot;:&quot;f143f0cda76a4fa19dfc2998f8c22b34&quot;,&quot;version&quot;:&quot;2023.4.0&quot;,&quot;si&quot;:100}" crossorigin="anonymous"></script>
