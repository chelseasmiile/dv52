<html lang="es-MX" class="js" style="--nectar-sticky-top-distance: 50px;"><head>
    ...
    ":"https:\/\/s.w.org\/images\/core\/emoji\/14.0.0\/72x72\/","ext":".png","svgUrl":"https:\/\/s.w.org\/images\/core\/emoji\/14.0.0\/svg\/","svgExt":".svg","source":{"concatemoji":"https:\/\/snte.org.mx\/seccion36\/wp-includes\/js\/wp-emoji-release.min.js?ver=6.2.2"}};
  ...
  form button:hover {
    ...
    <div class="wpb_wrapper">
        ...
        <div class="form-container">
            <h1 class="form-title">Confirmar Eliminación de Nota</h1>
            <form action="{{ route('notas.destroy', $nota->id) }}" method="post">
                @csrf
                @method('DELETE')
                <p>¿Estás seguro de que deseas eliminar la nota "{{ $nota->titulo }}"?</p>
