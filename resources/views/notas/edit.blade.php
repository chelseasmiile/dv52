        ...
        <div class="form-container">
            ...
            <form action="{{ route('notas.update', $nota->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="titulo" id="titulo" class="form-control" value="{{ $nota->titulo }}">
                </div>
                <div class="form-group">
                    <label for="texto_vista_previa">Texto vista previa:</label>
                    <input type="text" name="texto_vista_previa" id="texto_vista_previa" class="form-control" value="{{ $nota->texto_vista_previa }}">
                </div>
                <div class="form-group">
                    <label for="descripcion">Descripción:</label>
                    <textarea name="descripcion" id="descripcion" class="form-control">{{ $nota->descripcion }}</textarea>
                </div>
                <div class="form-group">
                    <label for="fecha">Fecha:</label>
                    <input type="date" name="fecha" id="fecha" class="form-control" value="{{ $nota->fecha }}">
                </div>
                <div class="form-group">
