<html lang="es-MX" class="js" style="--nectar-sticky-top-distance: 50px;"><head>
    ...
    <div class="row portfolio-items no-masonry isotope-activated" data-starting-filter="" data-gutter="default" data-masonry-type="default" data-bypass-cropping="" data-ps="8" data-loading="" data-categories-to-show="" data-col-num="cols-3" instance="0" style="position: relative; height: 2491.46px;">
    <div class="col span_4 element" data-project-cat="" data-default-color="true" data-title-color="" data-subtitle-color="" style="position: absolute; left: 0px; top: 0px; z-index: 1;">
    <div class="inner-wrap" data-animation="none">
    <div class="work-item style-2">
    <img class="skip-lazy top-level-image " src="img/nota1.jpg" width="600" height="400" alt="BASIFICACION.VALLEDEMEXICO.2023.15" title="BASIFICACION.VALLEDEMEXICO.2023.15">
    <div class="work-info-bg"></div>
    <div class="work-info">
    <a href="img/nota1.jpg" class="" target="_blank" data-fancybox="group_2813"></a>
    <div class="vert-center">
    <svg class="next-arrow" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 39 12"><line class="top" x1="23" y1="-0.5" x2="29.5" y2="6.5" stroke="#ffffff;"></line>
    ...
    <a id="to-top" href="#" class=" "><i class="fa fa-angle-up top-icon"></i><i class="fa fa-angle-up"></i></a>
