<html lang="es-MX" class="js" style="--nectar-sticky-top-distance: 50px;"><head>
    ...
    <div class="vc_col-sm-12 wpb_column column_container vc_column_container col no-extra-padding" data-padding-pos="all" data-has-bg-color="false" data-bg-color="" data-bg-opacity="1" data-animation="" data-delay="0">
      ...
      <div class="col span_3 post-{{ $galeria->id }} post type-post status-publish format-standard has-post-thumbnail category-galeriass36 one-fourths clear-both">
          <a href="{{ route('galerias.show', $galeria->id) }}"><img width="600" height="403" src="{{ asset('storage/' . $galeria->imagen_galeria) }}" class="attachment-portfolio-thumb size-portfolio-thumb wp-post-image" alt="{{ $galeria->titulo }}" decoding="async" title="{{ $galeria->titulo }}"></a>
          <div class="post-header">
              <h3 class="title"><a href="{{ route('galerias.show', $galeria->id) }}">{{ $galeria->titulo }}</a></h3>
          </div>
      </div>
  @endforeach
    </div>
