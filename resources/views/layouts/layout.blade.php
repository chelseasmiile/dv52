...
<li id="menu-item-32" class="menu-item menu-item-type-post_type menu-item-object-page nectar-regular-menu-item menu-item-32"><a href="{!!route('contacto.create')!!}"><span class="menu-title-text">Contacto</span></a></li>
